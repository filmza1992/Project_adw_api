...
module.exports.updateUserPassword = function updateUserPassword(req, res, next, body) {
  Member.updateUserPassword(body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
